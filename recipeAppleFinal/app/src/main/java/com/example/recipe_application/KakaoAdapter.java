...
public class KakaoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imag = (ImageView) convertView.findViewById(R.id.rowimage);
        TextView tvNum=(TextView)convertView.findViewById(R.id.tvNum);
        TextView tvName =(TextView)convertView.findViewById(R.id.tvName);
        TextView tvchef=(TextView)convertView.findViewById(R.id.tvChef);

        Fruit m = al.get(position);

        imag.setImageBitmap(m.img);
        tvNum.setText(m.num);
        tvName.setText(m.name);
        tvchef.setText(m.chef);
        return convertView;
    }
}
