...
public class Programlist_Click_Activity_wed_00_tasty extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BitmapDrawable drawable1 = (BitmapDrawable) getResources().getDrawable(R.drawable.wed1);
        Bitmap bitmap1 = drawable1.getBitmap();
        BitmapDrawable drawable2 = (BitmapDrawable) getResources().getDrawable(R.drawable.wed2);
        Bitmap bitmap2 = drawable2.getBitmap();
        BitmapDrawable drawable3 = (BitmapDrawable) getResources().getDrawable(R.drawable.wed3);
