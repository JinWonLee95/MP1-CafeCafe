...
public class Programlist_Activity_my extends ActionBarActivity implements AdapterView.OnItemClickListener {//몇화 요리명 셰프이름보여주는
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BitmapDrawable drawable2 = (BitmapDrawable) getResources().getDrawable(R.drawable.m7);
        Bitmap bitmap2 = drawable2.getBitmap();
        al.add(new Fruit("[1]","","마파두부",bitmap1));
        al.add(new Fruit("[2]","","브로컬리수프",bitmap2));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if(position ==0 ) {
            Intent intent = new Intent(Programlist_Activity_my.this, Programlist_Click_Activity_my_00.class);
            startActivity(intent);
        }
        else if(position ==1 ) {
            Intent intent = new Intent(Programlist_Activity_my.this, Programlist_Click_Activity_my_01.class);
            startActivity(intent);
        }
    }
} // end of class
